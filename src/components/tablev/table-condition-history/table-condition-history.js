...
import { Modal, Table, Popover, Icon } from 'antd';
import styles from './table-condition-history.styl';
import _ from 'lodash';
import { datetimeFormat } from '../../../utils/common';
import ConditionPreview from '../../condition-editor/blocks/condition-preview';
import { arrayToStateConditions } from '../../condition-editor/conditions-utils';
import DI from '../../../di';
  ...
  render() {
    ...
    return (
      <div className={styles.container}>
        <a className={styles.profile} onClick={::this.onShow}>
          <Icon type="profile" />
        </a>
        <Modal
